...
| Call                    | Description                                              |
+=========================+==========================================================+
| Warning = T/F    | Include / exclude warnings                               |
+-------------------------+----------------------------------------------------------+
| Echo = T/F       | Include / exclude r chunks but show output               |
+-------------------------+----------------------------------------------------------+
| Include = T/F   | Run code but do not include in the knitted document      |
+-------------------------+----------------------------------------------------------+
| Comment = "" \| Include | / exclude \#\# in output code chunks                     |
+-------------------------+----------------------------------------------------------+
| Message = T/F    | Includes / excludes message from code                    |
+-------------------------+----------------------------------------------------------+
