...
commonalities. Again, it won't be able to understand causality. It is
possible to combine labeled data, for example from the passed and look
for patterns with the unlabeled data.
...
| Symbol        | Explanation                                                               |
+===============+===========================================================================+
| **y**         | The real value. Generic output. The label. (ML) The thing I want to       |
|               | predict.                                                                  |
|               |                                                                           |
...
| **( y-ŷ)\^2** | Squared error                                                             |
+---------------+---------------------------------------------------------------------------+
| **x**         | Generic input / Features. The things I use to predict y.                  |
|               |                                                                           |
...
parameters (typically node weights) are derived though training. These
...
![](images/paste-C83C7277.png){width="557"}

![](images/paste-46CFCBC5.png){width="555"}
...
hyper plane and draw a line to separate the classes. If the objection is
to still make this separation in a hyper plane, there has to be some
